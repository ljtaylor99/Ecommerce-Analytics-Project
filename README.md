...
Scheduled SQL queries are set up and are extracting data to use for analysis. Work is currently being done to create Looker dashboards to display pertinent information. Here are the current ideas for possible dashboards:
